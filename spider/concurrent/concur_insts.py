...
def work_fetch(self):
    """
    process of fetching, auto running, and only return True
    """
    # ----1
...
def work_parse(self):
    """
    process of parsing, auto running, and only return True
    """
    # ----1
...
def work_save(self):
    """
    process of saving, auto running, and only return True
    """
    # ----1
...
def init_monitor_process(self, name, pool, sleep_time=5):
    """
    constructor of MonitorProcess
    """
    BaseProcess.__init__(self, name, None, pool)
    self.sleep_time = sleep_time        # sleeping time in every loop
    self.init_time = time.time()        # initial time of this spider
...
MonitorProcess = type("MonitorProcess", (BaseProcess,), dict(__init__=init_monitor_process, work=work_monitor))
