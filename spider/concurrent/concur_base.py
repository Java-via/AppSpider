...
class BaseConcur(object):
    """
    class of BaseConcur, as base class of Thread or Process
    """
    ...
    def __init__(self, name, worker, pool):
        ...
        self.pool = pool                # thread pool or process pool
        return
    ...
    def work(self):
        """
        process of each thread or process, return True to continue, False to stop
        """
...
class BaseThread(BaseConcur, threading.Thread):
    ...
    def work(self):
        """
        process of a thread, return True to continue, False to stop
        """
        raise NotImplementedError
...
class BaseProcess(BaseConcur, multiprocessing.Process):
    ...
    def work(self):
        """
        process of a process, return True to continue, False to stop
        """
        raise NotImplementedError
...
class BasePool(object):
    ...
    def __init__(self, fetcher, parser, saver, url_filter=None):
        ...
        self.lock = None                    # the lock which self.num_dict needs
        return
    ...
    def start_work_and_wait_done(self, fetcher_num, parser_num, is_over):
        """
    ...
    def is_all_tasks_done(self):
        """
        check if all tasks are done in this pool
        """
    ...
    def update_number_dict(self, key, value):
        """
        update number_dict of this pool. if value is 0, set key to value
        """
        self.lock.acquire()
        if value == 0:
