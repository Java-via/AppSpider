...
def make_cookies_maps(cookies_maps):
    """
    make cookies list from a map_list, cookies_maps: [{"name": xx, "value": xx, "domain": xx, ...}, ...]
    :key: for cookie in cookie_list: cookiejar.set_cookie(cookie)
    """
    cookies_list = [
...
def make_cookies_string(cookies_string, domain):
    """
    make cookies list from a string, cookies_string: "name1=value1; name2=value2"
    :key: for cookie in cookie_list: cookiejar.set_cookie(cookie)
    """
